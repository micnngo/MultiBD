...
derivatives_lt_invert_Cpp <- function(t, lambda1, lambda2, alpha, beta, powI_inf, powI_rem, S0, I0, Ap1, Bp1, ord, direction, nblocks, tol, computeMode, nThreads) {
    .Call('_MultiBD_derivatives_lt_invert_Cpp', PACKAGE = 'MultiBD', t, lambda1, lambda2, alpha, beta, powI_inf, powI_rem, S0, I0, Ap1, Bp1, ord, direction, nblocks, tol, computeMode, nThreads)
}
...
SIR_derivatives_Cpp <- function(t, alpha, beta, powI_inf, powI_rem, S0, I0, Ap1, Bp1, ord, direction, nblocks, tol, computeMode, nThreads) {
    .Call('_MultiBD_SIR_derivatives_Cpp', PACKAGE = 'MultiBD', t, alpha, beta, powI_inf, powI_rem, S0, I0, Ap1, Bp1, ord, direction, nblocks, tol, computeMode, nThreads)
}
